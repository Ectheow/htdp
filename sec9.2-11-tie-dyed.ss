...
#reader(lib "htdp-beginner-reader.ss" "lang")((modname sec9.2-11-tie-dyed) (read-case-sensitive #t) (teachpacks ((lib "draw.rkt" "teachpack" "htdp"))) (htdp-settings #(#t constructor repeating-decimal #f #t none #f ((lib "draw.rkt" "teachpack" "htdp")) #f)))
  ...
  (cond
    ...
    [else
      (cons (random-n-m 20 120) 
            (tie-dyed (sub1 n)))]))
(start 500 500)
(draw-circles (make-posn 250 250) (tie-dyed 200))